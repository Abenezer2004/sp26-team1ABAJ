...
public class AppointmentService {
    ...
    public List<Appointment> getAppointmentsByNurseAndStatus(Long nurseId, AppointmentStatus status) {
        return appointmentRepository.findByNurse_UserIdAndStatus(nurseId, status);
    }
